...
import 'package:week_3_blabla_project/ui/providers/ride_pref_proivder.dart';
  ...
  void onPreferencePressed(BuildContext context) async {
    ...
    RidePreference? newPreference = await Navigator.of(
      ...
      AnimationUtils.createTopToBottomRoute(
        RidePrefModal(initialPreference: context.read<RidePrefProivder>().currentPreference),
      ),
    );
